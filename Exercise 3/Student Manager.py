...
def update_table(view):
    ...
    for student in filtered_students:
        table.insert('', 'end', values=(student['name'], student['student_no'], student['total_coursemark'], 
                                        student['exam_score'], f"{student['total_percentage']:.2f}%", student['grade']))
...
view_options = [student['name'] for student in students]
